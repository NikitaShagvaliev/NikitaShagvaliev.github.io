...
function render_boost(parent, boost){
  ...
  <div class="boost-holder" id="boost-holder">
    <input id="buy" type="image" class="catgirl boost" src="https://sun9-4.userapi.com/JO1SBuQbEDDpuNW2aekhTw15hl3rDPzjgw4Eiw/yvzmNOWOwio.jpg" onclick="buyBoost(${boost.level})" />
